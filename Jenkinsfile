...
@Library('github.com/mozmar/jenkins-pipeline@15a2f1aeb08e58e2ee325c072b596d198771ccf9')
...
stage ('Checkout') {
    node {
        ...
        // this won't work until we approve some script restrictions in Jenkins
